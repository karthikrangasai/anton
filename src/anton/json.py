...
from anton.core.loader import json_load

StrOrBytesPath = Union[str, Path, PathLike]


def _json_conf_wrapper(
    cls,
    /,
    *,
    repr: bool = True,
...
def json_conf(
    *,
    ...
    decorator to provide auto instantiation from json definitions with runtime type checking of values.
    ...
    .. note::
        ...
        Except `conf_path` all other arguments to :py:func:`anton.json.json_conf` are directly passed on
